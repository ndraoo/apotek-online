     ...
     <div class="container py-16">
            ...
            <div class="grid grid-cols-3 gap-3">
                <div class="relative rounded-sm overflow-hidden group">
                    <img src="public/buyer/images/category/category-1.jpg" alt="category 1" class="w-full" />
                    <a href="#"
                ...
                <div class="relative rounded-sm overflow-hidden group">
                    <img src="public/buyer/images/category/category-2.jpg" alt="category 1" class="w-full" />
                    <a href="#"
                ...
                <div class="relative rounded-sm overflow-hidden group">
                    <img src="public/buyer/images/category/category-3.jpg" alt="category 1" class="w-full" />
                    <a href="#"
                ...
                <div class="relative rounded-sm overflow-hidden group">
                    <img src="public/buyer/images/category/category-4.jpg" alt="category 1" class="w-full" />
                    <a href="#"
                ...
                <div class="relative rounded-sm overflow-hidden group">
                    <img src="public/buyer/images/category/category-5.jpg" alt="category 1" class="w-full" />
                    <a href="#"
                ...
                <div class="relative rounded-sm overflow-hidden group">
                    <img src="public/buyer/images/category/category-6.jpg" alt="category 1" class="w-full" />
                    <a href="#"
